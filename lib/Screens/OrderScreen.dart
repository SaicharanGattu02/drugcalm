                          ...
                          Container(
                              ...
                              child: Column(mainAxisAlignment: MainAxisAlignment.start,
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      text(context, '    ₹ 2,546    ', 18, color: color11, textAlign: TextAlign.right, fontWeight: FontWeight.w500),
                                      SizedBox(
                                        width: w * .04,
                                      ),
                                      text(context, 'MARGIN', 12, color: color11, textAlign: TextAlign.right, fontWeight: FontWeight.w500),
                                      SizedBox(
                                        width: w * .04,
                                      ),
                                      text(context, '18 %', 12, color: color1, textAlign: TextAlign.right, fontWeight: FontWeight.w500),
