      ...
      if (res != null) {
        setState(() {
          if (res.settings?.success == 1) {
            ...
            print("API response status is not successful:");
          }
          isLoading = false;
        });
      } else {
                      ...
                      if ((orderdetails?.items ?? []).length > 0) ...[
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            print("Product quantity:${cartdata?.product.quantity}");
                            return Container(
                              width: double
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Text(
                                                  cartdata?.product.quantity.toString() ??"",
                                                  style: TextStyle(
                                                    fontSize: 12,
                                                    fontWeight: FontWeight.w400,
                                                    color: Color(0xFF000000),
