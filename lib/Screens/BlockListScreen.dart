...
class _BlocklistscreenState extends State<Blocklistscreen> {
  ...
  Future<void> GetBlockList() async {
    final blockList = Provider.of<BlockListProvider>(context, listen: false);
    blockList.fetchBlockList();
  }


  Future<void> removeBlockList(String id) async {
    final removeBlockList =Provider.of<BlockListProvider>(context,listen: false);
    removeBlockList.removeBlockList(id);
  }
              ...
              child: CustomScrollView(
                slivers: [
                  ...
                  Consumer<BlockListProvider>(
                    builder: (context, block_list_Data, child) {
                      return SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, index) {
                            final block_list =
                                block_list_Data.blockListProducts;
                            final data = block_list[index];
                          ...
                          childCount: block_list_Data.blockListProducts.length,
                        ),
                      );
                    },
                  ),
